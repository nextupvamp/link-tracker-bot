...
public class JpaPersistenceImplementationTest {
    ...
    @Test
    public void testJpaAccessType() {
        assertThat(applicationContext.getBean(SubscriptionJpaRepository.class)).isNotNull();
        assertThat(applicationContext.getBean(ChatJpaRepository.class)).isNotNull();
        assertThrows(
                NoSuchBeanDefinitionException.class,
                () -> applicationContext.getBean(SubscriptionJdbcRepository.class));
        assertThrows(NoSuchBeanDefinitionException.class, () -> applicationContext.getBean(ChatJdbcRepository.class));
    }
}
